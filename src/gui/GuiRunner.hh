...
class GZ_SIM_GUI_VISIBLE GuiRunner : public QObject
{
  ...
  /// \param[in] _msg New state message.
  /// \param[in] _fullState True if this is a full state update, false if incremental.
  private: Q_INVOKABLE void OnStateQt(const gz::msgs::SerializedStepMap &_msg, bool _fullState);
